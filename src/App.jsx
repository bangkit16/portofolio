     ...
     <div className="px-4 flex items-center">
      ...
      >
       <ul className="block lg:flex">
        <li className="group">
         <a href="#hero" className="text-base flex text-slate-900 py-2 mx-8 group-hover:text-green-500">
          Home
         </a>
        </li>
        <li className="group">
         <a href="#about" className="text-base flex text-slate-900 py-2 mx-8 group-hover:text-green-500">
          Tentang Saya
         </a>
        </li>
        <li className="group">
         <a href="#skills" className="text-base flex text-slate-900 py-2 mx-8 group-hover:text-green-500">
          Skills
         </a>
        </li>
        <li className="group">
         <a href="#projek" className="text-base flex text-slate-900 py-2 mx-8 group-hover:text-green-500">
          Portfolio
         </a>
        </li>
        <li className="group">
         <a href="#contact" className="text-base flex text-slate-900 py-2 mx-8 group-hover:text-green-500">
          Kontak
         </a>
        </li>
       </ul>
    ...
    <div className="container mx-auto px-4 overflow-hidden mb-16">
     <div className=" flex w-full flex-wrap  mt-32 lg:mt-16 self-center  ">
      <div className="block w-full my-auto self-center lg:w-1/2">
       <span className="font-bold text-green-500 text-base lg:text-2xl">Halo semua, Saya</span>
       <h1 className="text-4xl lg:text-5xl mb-2 font-bold text-slate-900">Bangkit Maulana Caniago</h1>
       {/* <h3
       ...
       <span></span>
       <br />
       <a href="#contact" className=" rounded-xl lg:text-xl  bg-green-500 text-white font-bold py-2 px-4 text-base">
        Contact Me
       </a>
      </div>
      <div className="flex  w-full self-end content-center lg:w-1/2">
       <div className="mt-10 relative">
        <img className=" mx-auto inset-0 max-w-full center" src={portoIMG} alt="" />
    ...
    <div className="container mb-20 mx-auto">
     <div className="flex flex-wrap">
      <div className="lg:w-1/2 w-full px-4 mb-10">
       <h4 className="text-lg font-bold uppercase text-green-500 mb-3">Tentang saya</h4>
       ...
       <p className="lg:text-lg font-medium text-base text-slate-500 max-w-xl">
        Halo! Saya Mahasiswa jurusan Teknologi Informasi program studi Sistem Informasi Bisnis di Politeknik Negeri
        Malang dengan IPK 3.70 (Semester 6) dan seorang web developer yang berdedikasi. Saya bersemangat dalam
        menciptakan solusi web yang inovatif dan memiliki keahlian dalam berbagai teknologi web untuk mengembangkan
        aplikasi yang responsif dan fungsional.
       </p>
       <div className="mt-5">
        <a
      ...
      <div className="lg:w-1/2 w-full px-4">
       <h3 className="lg:pt-10 lg:text-3xl font-semibold text-slate-900 text-2xl mb-3 max-w-xl">Let's Connect</h3>
       <p className="lg:text-lg font-medium text-base text-slate-500 mb-6">
        Jika Anda memiliki pertanyaan, saran, atau hanya ingin menyapa, jangan ragu untuk menghubungi saya melalui saya.
       ...
       <div className="flex items-center">
        <a
         ...
         target="blank"
        >
         <svg role="img" className="fill-current" width="30" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
 ...
 return (
  <>
   <section id="pendidikan" className="bg-slate-100">
    {/* <div className=" border-6 border-red-800 shadow-lg">sadasd</div> */}0
  ...
  return (
   <>
    ...
    <div className="text-[#EF4223] w-full hover:text-green-500 transition-colors">
     ...
     <h3 className="text-center mt-4 font-semibold text-slate-900 text-lg">CodeIgniter</h3>
    </div>
   </>
  );
 }
  ...
  <>
   <section id="skills">
    <div className="container px-4 mx-auto mb-20 mt-20 pt-40">
     <h4 className="text-lg text-center font-bold uppercase text-green-500 mb-3">skills</h4>
     <h2 className="text-center font-bold text-3xl lg:text-4xl mb-5">Keahlian</h2>
     <p className="text-center lg:w-4/6 w-5/6 mx-auto font-medium text-base text-slate-500 mb-8 lg:text-lg">
      Saya menguasai berbagai teknologi web untuk menciptakan aplikasi yang responsif dan fungsional.
     </p>
    ...
    <div className="w-full lg:w-1/3 relative  transition-transform">
     <div className=" border-slate-200 w-full h-[500px] relative bg-transparent rounded-xl m-2 p-4 flex flex-col">
      <div className="w-full h-[13rem]  overflow-hidden flex rounded-md">
       <img className=" object-cover w-full object-top hover:scale-110 transition" src={gambar} alt="" />
      </div>

      <h4 className="mt-4 font-bold text-lg">{nama}</h4>
      <span className="font-semibold text-base text-green-500">{tool}</span>
   ...
   <section id="projek">
    <div className="container mx-auto mb-20 mt-20 pt-40">
     <div className="w-full px-4">
      <h4 className="text-lg text-center font-bold uppercase mb-3 text-green-500 ">portofolio</h4>
      <h2 className="text-center font-bold text-3xl mb-8 lg:text-4xl ">PROJEK</h2>
      <p className="text-center lg:w-4/6 w-5/6 mx-auto font-medium text-base text-slate-500 mb-8 lg:text-lg">
    ...
    <div className="container mx-auto px-4 pt-24 mb-20">
     <div className="flex flex-wrap ">
      <div className="w-full mx-auto p-6  lg:w-1/2">
       <h4 className="text-lg  font-bold uppercase mb-3 text-green-500 ">kontak</h4>
       <h2 className=" font-bold text-2xl mb-4 lg:text-3xl ">Hubungi Saya</h2>

       <p className="text-gray-500 mb-6  lg:text-lg text-base">
        Jika Anda memiliki pertanyaan, saran, atau hanya ingin menyapa, jangan ragu untuk menghubungi saya melalui
        formulir ini. Saya siap membantu Anda😁😁
       </p>
       <a href="https://wa.me/+6282232801273" className="flex group align-middle items-center" target="blank">
        ...
        <span className="group-hover:text-green-500 transition-colors">082232801273</span>
       </a>
       <a href="mailto:bangkitcaniago@gmail.com" target="blank" className=" mt-2 flex align-middle items-center group">
        <div className="w-12 h-12 mr-3 border rounded-full flex justify-center items-center border-slate-300 group-hover:bg-green-500 group-hover:text-white transition">
        ...
        <span className="group-hover:text-green-500 transition-colors">bangkitcaniago@gmail.com</span>
       </a>
       <a
        href="https://www.linkedin.com/in/bangkit-maulana-caniago/"
        target="blank"
       ...
       >
        ...
        <span className="group-hover:text-green-500 transition-colors">Bangkit Maulana Caniago</span>
       </a>
      </div>
   ...
   <footer className="w-full bg-slate-800 glossy-effect ">
    <div className="container px-4 mx-auto pt-10 pb-6 text-white">
     <div className="w-full px-4 flex flex-wrap">
      <a href="#hero" className="py-10  mb-30 font-bold text-3xl hover:text-green-500 transition-colors">
       BANGKIT <span className="text-green-500">CANIAGO</span>
      </a>
      <div className="flex flex-wrap w-full justify-center">
       <div className="w-full block lg:w-1/3 mb-6">
        ...
        <div className="w-full block pl-3">
         <a
          ...
          className=" mt-2 flex align-middle items-center group"
         >
          <span className="group-hover:text-green-500 mb-3 transition-colors">bangkitcaniago@gmail.com</span>
         </a>
         <a href="https://wa.me/+6282232801273" className="flex group align-middle items-center" target="blank">
          <span className="group-hover:text-green-500 mb-3 transition-colors">082232801273</span>
         </a>
       ...
       <div className="w-full block lg:w-1/3 mb-6">
        ...
        <ul className="block text-white">
         <li className="group">
          <a href="#hero" className="text-base flex py-2 ml-3 group-hover:text-green-500">
           Home
          </a>
         </li>
         <li className="group">
          <a href="#about" className="text-base flex py-2 ml-3 group-hover:text-green-500">
           Tentang Saya
          </a>
         </li>
         <li className="group">
          <a href="#skills" className="text-base flex py-2 ml-3 group-hover:text-green-500">
           Skills
          </a>
         </li>
         <li className="group">
          <a href="#projek" className="text-base flex py-2 ml-3 group-hover:text-green-500">
           Portfolio
          </a>
         </li>
         <li className="group">
          <a href="#contact" className="text-base flex py-2 ml-3 group-hover:text-green-500">
           Kontak
          </a>
         </li>
        </ul>
       ...
       <h5 className="text-center text-slate-500 mt-6">&copy; 2024 Reserved by Bangkit Maulana Caniago</h5>
      </div>
     </div>
    </div>
   </footer>
